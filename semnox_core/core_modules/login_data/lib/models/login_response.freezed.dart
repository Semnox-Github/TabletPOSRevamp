...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({LoginData? data, String? exception});
...
class _$_LoginResponse with DiagnosticableTreeMixin implements _LoginResponse {
  const _$_LoginResponse({this.data, this.exception});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LoginResponse(data: $data, exception: $exception)';
  }
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      {final LoginData? data, final String? exception}) = _$_LoginResponse;
