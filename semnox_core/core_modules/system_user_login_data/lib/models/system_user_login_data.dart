...
part 'system_user_login_data.freezed.dart';
part 'system_user_login_data.g.dart';

@freezed
class SystemUserLoginData with _$SystemUserLoginData {
  const factory SystemUserLoginData({
  ...
  }) = _SystemUserLoginData;

  factory SystemUserLoginData.fromJson(Map<String, Object?> json) => _$SystemUserLoginDataFromJson(json);
}