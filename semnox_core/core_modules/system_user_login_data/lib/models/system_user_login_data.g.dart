...
_$_SystemUserLoginData _$$_SystemUserLoginDataFromJson(
        Map<String, dynamic> json) =>
    _$_SystemUserLoginData(
...
Map<String, dynamic> _$$_SystemUserLoginDataToJson(
        _$_SystemUserLoginData instance) =>
    <String, dynamic>{
