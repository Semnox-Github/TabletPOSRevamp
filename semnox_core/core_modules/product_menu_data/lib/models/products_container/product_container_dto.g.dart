...
part of 'product_container_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$_ProductContainerDTO _$$_ProductContainerDTOFromJson(
        Map<String, dynamic> json) =>
    _$_ProductContainerDTO(
      ...
      issueNotificationDevice: json['IssueNotificationDevice'] as bool?,
      isRecommended: json['IsRecommended'] as bool,
      searchDescription: json['SearchDescription'] as String,
      maxQtyPerDay: json['MaxQtyPerDay'] as int?,
      ...
      gratuityPercentage: (json['GratuityPercentage'] as num?)?.toDouble(),
    );

Map<String, dynamic> _$$_ProductContainerDTOToJson(
        _$_ProductContainerDTO instance) =>
    <String, dynamic>{
