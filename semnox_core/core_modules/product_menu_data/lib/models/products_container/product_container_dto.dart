...
part 'product_container_dto.freezed.dart';
part 'product_container_dto.g.dart';


@freezed
class ProductContainerDTO with _$ProductContainerDTO {
  const factory ProductContainerDTO({
  ...
  }) = _ProductContainerDTO;

  factory ProductContainerDTO.fromJson(Map<String, dynamic> json) => _$ProductContainerDTOFromJson(json);
}
