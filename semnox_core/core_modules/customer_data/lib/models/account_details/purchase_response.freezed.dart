...
mixin _$PurchaseResponse {
  List<PurchaseData>? get data => throw _privateConstructorUsedError;
...
abstract class $PurchaseResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<PurchaseData>? data, String? exception});
}
...
/// @nodoc
@JsonSerializable()
class _$_PurchaseResponse implements _PurchaseResponse {
  const _$_PurchaseResponse({final List<PurchaseData>? data, this.exception})
      : _data = data;

  factory _$_PurchaseResponse.fromJson(Map<String, dynamic> json) =>
      _$$_PurchaseResponseFromJson(json);

  final List<PurchaseData>? _data;
  @override
  List<PurchaseData>? get data {
    final value = _data;
  ...
  @override
  String toString() {
    return 'PurchaseResponse(data: $data, exception: $exception)';
  }
...
abstract class _PurchaseResponse implements PurchaseResponse {
  const factory _PurchaseResponse(
      ...
      final String? exception}) = _$_PurchaseResponse;
