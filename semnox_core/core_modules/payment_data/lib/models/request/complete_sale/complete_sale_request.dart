...
part 'complete_sale_request.freezed.dart';
part 'complete_sale_request.g.dart';

@freezed
class CompleteSaleRequest with _$CompleteSaleRequest {
  const factory CompleteSaleRequest({
  ...
  factory CompleteSaleRequest.fromJson(Map<String, dynamic> json) => _$CompleteSaleRequestFromJson(json);
}