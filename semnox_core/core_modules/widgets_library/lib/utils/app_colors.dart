...
class AppColors{
  ...
  static  Color backGroundGreyLightColor1 = _theme.cardStateUnselectedLight??const Color(0xFFF0F2F8);
  static  Color backGroundBlackColor1 = const Color.fromARGB(255, 61, 61, 61);
