...
final tsS19W50016 = GoogleFonts.robotoCondensed(color: colorBlack16, fontSize: 19, fontWeight: FontWeight.w500);
final tsS19W70016 = GoogleFonts.robotoCondensed(color: colorBlack16, fontSize: 19, fontWeight: FontWeight.w700);
final tsS20W700FF = GoogleFonts.robotoCondensed(color: colorWhite, fontSize: 20, fontWeight: FontWeight.w700);
final tsS20W50016 = GoogleFonts.robotoCondensed(color: colorBlack16, fontSize: 20, fontWeight: FontWeight.w500);
...
final tsS26W70016 = GoogleFonts.robotoCondensed(color: colorBlack16, fontSize: 26, fontWeight: FontWeight.w700);
