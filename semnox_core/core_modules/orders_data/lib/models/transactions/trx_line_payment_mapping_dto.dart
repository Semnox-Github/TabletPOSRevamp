...
part 'trx_line_payment_mapping_dto.freezed.dart';
part 'trx_line_payment_mapping_dto.g.dart';

@freezed
class TrxLinePaymentMappingDTO with _$TrxLinePaymentMappingDTO{
  const factory TrxLinePaymentMappingDTO({
    ...
    @Default(false)
    bool isSelected,
  }) = _TrxLinePaymentMappingDTO;

  factory TrxLinePaymentMappingDTO.fromJson(Map<String, dynamic> json) => _$TrxLinePaymentMappingDTOFromJson(json);
}