...
class IdProofWidget extends StatefulWidget {
  final String title;
  VoidCallback? onPress;
  String? image;
  TextEditingController? idProofFileURL;

  IdProofWidget({required this.title, super.key,this.onPress,this.image,this.idProofFileURL});

  @override
  State<IdProofWidget> createState() => _IdProofWidgetState();
}

class _IdProofWidgetState extends State<IdProofWidget> {
            ...
            children: [
              ...
              InkWell(
                ...
                child:widget.idProofFileURL?.text.isNotEmpty == true?_getImage(widget.idProofFileURL?.text) :image == null ? Image.asset(
                  ...
                  color: theme.primaryOpposite,width: 70,height: 70,
                ) : Image.file(File(image!.path),width: 70,height: 70,),
              ),
