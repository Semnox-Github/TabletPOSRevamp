...
class NewDropDownWidget extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(title, style:  theme.heading5?.copyWith( fontSize:SizeConfig.getFontSize(30), fontWeight: FontWeight.normal) ),
        ...
        DropdownButtonFormField(
          ...
          hint: Text(hint, style: theme.textFieldHintStyle?.copyWith( fontSize:SizeConfig.getFontSize(18)), overflow: TextOverflow.ellipsis,),
