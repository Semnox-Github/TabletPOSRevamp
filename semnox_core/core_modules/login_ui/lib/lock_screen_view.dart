...
class LockScreenView extends StatefulWidget {
  ...
  const LockScreenView({Key? key, required this.onLoginSuccess}) : super(key: key);
...
class _LockScreenViewState extends State<LockScreenView> {
  ...
  Future<void> initBloc() async {
    ...
    final result = await systemUserLoginBL.loginWithoutSave(machineName: machineId.toUpperCase(), siteId: execContextDTO.siteId ?? -1);
        ...
        child: BlocConsumer<LoginBloc, LoginState>(
          ...
          listener: (_, loginState) {
            ...
            if (list != null) {
              ...
              final defaultSite = list.where((element) => element.siteId == _defaultSiteId);
            ...
            if (loginState is ErrorState) {
              ...
              Log.printMethodEnd("_onLoginClick()", "Lock Screen", "Login");
              Log.printMethodReturn("_onLoginClick() - Login Successful.", "Lock Screen", "Login");
              Future.microtask(() async {
                if(mounted) {
                  loader.hideLoaderDialog(context);
              ...
              Future.microtask(() => loader.showLoaderDialog(context, MessagesProvider.get("Authenticating...")));
            }
          },
  ...
  Widget _buildLoginForm(BuildContext context, List<SiteDTO> dropDownList) {
    final theme = Theme.of(context).extension<SemnoxTheme>()!;
    return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              style: theme.heading5?.copyWith(fontSize: SizeConfig.isBigDevice() ? SizeConfig.getFontSize(22) : SizeConfig.getFontSize(26), fontWeight: FontWeight.w400),
              validator: (value) {
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                  ...
                  textStyle: theme.headingLight5?.copyWith(fontSize: SizeConfig.getFontSize(32), color: Colors.white)),
              onPressed: () async {
                ...
                if (_formKey.currentState!.validate()) {
                  ...
                  final executionContext = _getExecutionContextFromSysLogin(result);
                  final userLoginBL = await LoginDataBuilder.build(executionContext);
                  ...
                  Log.printMethodStart("_onLoginClick()", "Lock Screen", "Login");
                  _loginBloc.setLoginBL(userLoginBL);
                  _loginBloc.setLoginRequest(loginRequest);
                  _loginBloc.add(LoginClickEvent());
                }
              },
              child: Text(MessagesProvider.get("Login"), style: theme.heading1?.copyWith(fontSize: SizeConfig.getFontSize(30), color: Colors.white)),
            ),
            SizedBox(height: SizeConfig.getSize(8)),
            _isNfcAvailable
                ? Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: AutoSizeText(
                        ...
                        style: theme.heading5?.copyWith(fontSize: SizeConfig.getFontSize(20), fontWeight: FontWeight.w400) ?? tsS14W40016,
                      ),
                    ),
                    Expanded(
                      child: Divider(
