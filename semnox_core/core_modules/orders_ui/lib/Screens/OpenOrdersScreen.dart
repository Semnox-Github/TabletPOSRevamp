...
import 'package:orders_ui/cubit/open_orders_cubit.dart';
import '../cubit/open_orders_cubit_state.dart';
...
class _OpenOrdersScreenState extends State<OpenOrdersScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      setNotification.value = NotificationMessage(message: MessagesProvider.get("View Open Orders"),color:theme.footerBG4);
    });
  }
                            ...
                            child: Column(
                              children: [
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Expanded(
                                          child:
                                          BlocBuilder<OpenOrdersCubit, OpenOrdersCubitState>(
                                                     ...
                                                     return OrderListItemWidget(
                                                         ...
                                                         onCheckChange:(int orderId ,bool isUncheck,int currentindex){
                                                           if(isUncheck){
                                                             ...
                                                             context.read<OpenOrdersCubit>().rebuild();
                                ...
                                OrderActionMode(
                                  ...
                                  onMove: (){
                                      print("ID : "+TT.selectedOuterTableId.value);
                                      showDialog(
                                        context: context,
  ...
  _search() async{
    ...
    _loadingMessage = MessagesProvider.get("Loading Open Orders");
    _setLoadingStatus(true);
    final execContextBL = await ExecutionContextBuilder.build();
    final executionContextDTO = execContextBL.getExecutionContext();
    final orderSearchBL = await OrdersDataBuilder.build(executionContextDTO!);
    ...
    try{
      ...
      var response = await orderSearchBL.getOrdersData(
        ...
        status: (_status?.orderStatus == null || _status?.orderStatus == "All") ? "INITIATED,ORDERED" : _status?.orderStatus,
