...
//
//     final transferCardRequestModel = transferCardRequestModelFromJson(jsonString);

import 'dart:convert';

TransferCardRequestModel transferCardRequestModelFromJson(String str) =>
    TransferCardRequestModel.fromJson(json.decode(str));

String transferCardRequestModelToJson(TransferCardRequestModel data) =>
    json.encode(data.toJson());

class TransferCardRequestModel {
  TransferCardRequestModel({
    this.accountTaskId,
  ...
  factory TransferCardRequestModel.fromJson(Map<String, dynamic> json) =>
      TransferCardRequestModel(
