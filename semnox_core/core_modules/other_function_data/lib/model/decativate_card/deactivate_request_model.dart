...
//
//     final deactivateCardRequestModel = deactivateCardRequestModelFromJson(jsonString);

import 'dart:convert';

DeactivateCardRequestModel deactivateCardRequestModelFromJson(String str) =>
    DeactivateCardRequestModel.fromJson(json.decode(str));

String deactivateCardRequestModelToJson(DeactivateCardRequestModel data) =>
    json.encode(data.toJson());

class DeactivateCardRequestModel {
  ...
  factory DeactivateCardRequestModel.fromJson(Map<String, dynamic> json) =>
      DeactivateCardRequestModel(
