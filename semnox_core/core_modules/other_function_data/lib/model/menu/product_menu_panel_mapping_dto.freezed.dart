...
ProductMenuPanelMappingDto _$ProductMenuPanelMappingDtoFromJson(
    Map<String, dynamic> json) {
  return _ProductMenuPanelMappingDto.fromJson(json);
}

/// @nodoc
mixin _$ProductMenuPanelMappingDto {
  @JsonKey(name: 'Id')
  ...
  @JsonKey(ignore: true)
  $ProductMenuPanelMappingDtoCopyWith<ProductMenuPanelMappingDto>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ProductMenuPanelMappingDtoCopyWith<$Res> {
  factory $ProductMenuPanelMappingDtoCopyWith(ProductMenuPanelMappingDto value,
          $Res Function(ProductMenuPanelMappingDto) then) =
      _$ProductMenuPanelMappingDtoCopyWithImpl<$Res,
          ProductMenuPanelMappingDto>;
  @useResult
  $Res call(
      {@JsonKey(name: 'Id') int? id,
      @JsonKey(name: 'PanelId') int? panelId,
...
/// @nodoc
class _$ProductMenuPanelMappingDtoCopyWithImpl<$Res,
        $Val extends ProductMenuPanelMappingDto>
    implements $ProductMenuPanelMappingDtoCopyWith<$Res> {
  _$ProductMenuPanelMappingDtoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_ProductMenuPanelMappingDtoCopyWith<$Res>
    implements $ProductMenuPanelMappingDtoCopyWith<$Res> {
  factory _$$_ProductMenuPanelMappingDtoCopyWith(
          _$_ProductMenuPanelMappingDto value,
          $Res Function(_$_ProductMenuPanelMappingDto) then) =
      __$$_ProductMenuPanelMappingDtoCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'Id') int? id,
...
/// @nodoc
class __$$_ProductMenuPanelMappingDtoCopyWithImpl<$Res>
    extends _$ProductMenuPanelMappingDtoCopyWithImpl<$Res,
        _$_ProductMenuPanelMappingDto>
    implements _$$_ProductMenuPanelMappingDtoCopyWith<$Res> {
  __$$_ProductMenuPanelMappingDtoCopyWithImpl(
      _$_ProductMenuPanelMappingDto _value,
      $Res Function(_$_ProductMenuPanelMappingDto) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_ProductMenuPanelMappingDto(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$_ProductMenuPanelMappingDto implements _ProductMenuPanelMappingDto {
  const _$_ProductMenuPanelMappingDto(
      {@JsonKey(name: 'Id') this.id,
      @JsonKey(name: 'PanelId') this.panelId,
  ...
  factory _$_ProductMenuPanelMappingDto.fromJson(Map<String, dynamic> json) =>
      _$$_ProductMenuPanelMappingDtoFromJson(json);
  ...
  @override
  String toString() {
    return 'ProductMenuPanelMappingDto(id: $id, panelId: $panelId, menuId: $menuId, isActive: $isActive, createdBy: $createdBy, creationDate: $creationDate, lastUpdatedBy: $lastUpdatedBy, lastUpdatedDate: $lastUpdatedDate, siteId: $siteId, masterEntityId: $masterEntityId, synchStatus: $synchStatus, guid: $guid, isChanged: $isChanged)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_ProductMenuPanelMappingDto &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_ProductMenuPanelMappingDtoCopyWith<_$_ProductMenuPanelMappingDto>
      get copyWith => __$$_ProductMenuPanelMappingDtoCopyWithImpl<
          _$_ProductMenuPanelMappingDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ProductMenuPanelMappingDtoToJson(
      this,
    );
  }
}

abstract class _ProductMenuPanelMappingDto
    implements ProductMenuPanelMappingDto {
  const factory _ProductMenuPanelMappingDto(
          {@JsonKey(name: 'Id') final int? id,
          @JsonKey(name: 'PanelId') final int? panelId,
  ...
  factory _ProductMenuPanelMappingDto.fromJson(Map<String, dynamic> json) =
      _$_ProductMenuPanelMappingDto.fromJson;
