...
_$_TransactionPaymentDTO _$$_TransactionPaymentDTOFromJson(
    ...
    _$_TransactionPaymentDTO(
      ...
      paymentTransactionDTOList: (json['PaymentTransactionDTOList']
              as List<dynamic>)
          .map((e) => CompleteSaleRequest.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      tipReqAmt: (json['tipReqAmt'] as num?)?.toDouble(),
    );
